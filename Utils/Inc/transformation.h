...
static inline void ParkTransform(float alpha, float beta, float theta, Park_t* out)
{
...
static inline void InvClarkeTransform(float alpha, float beta, PhaseABC_t* out)
{
#if (defined(TWO_PHASE_CURRENT_SENSING))

...
#if !defined(Encoder_Position) && !defined(Resolver_Position) \
    && !defined(Software_Position)
#    error "Please define Positon Sensor Entry in positon_sensor.h"
#endif

#define Excitation_Frequency 0x28  // 10kHz
#define Control_Register_Data \
    0x7D  // 14 bits Resolution, 16 bits EncoderResolution
...
extern uint8_t
    Resolver_Fault;  // monitor Variable though CCP, may be used as fault flag then
#endif
